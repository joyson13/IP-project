                        ...
                        <script>
                          function calculateBMI() {
                            ...
                            if (weight > 0 && height > 0) {
                              ...
                              result.setInnerHTML(finalBmi);
                              if (finalBmi < 18.5) {  
                                result.setInnerHTML(" You are underweight.");
                              }
                              if (finalBmi > 18.5 && finalBmi < 24.9) {
                                result.setInnerHTML(" You are normal.");
                              }
                              if (finalBmi > 24.9 && finalBmi < 29.99) {
                                result.setInnerHTML(" You are overweight.");
                              }
                            } else {
                              result.setInnerHTML(" You are obese.");
                              }
