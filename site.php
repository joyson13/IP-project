...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
          ...
          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
            ...
            <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <div class="text">
                ...
                <p>Help you find your starting point build your path to success. Show you the ropes. Be with you every step of the way. Guarantee satisfaction.</p>
          ...
          <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
            ...
            <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <div class="text">
                ...
                <p>Personal training, Group exercise classes, bootcamp, Cliffy's Studio®, Cliffy's AMP™</p>
  ...
  <section class="ftco-section ftco-services ftco-no-pt ftco-no-pb" style="background-color: #17a2b8;">
    <div class="container">
      <div class="row no-gutters services-section">
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block" style="background-color : #42c0fb;">
            <div class="icon"><span class="flaticon-body"></span></div>
            <div class="media-body">
              <h3 class="heading mb-3">Free Lesson</h3>
              <p style="background-color : #42c0fb;">Try any lesson for a day, choose a trainer of your choice, and get yourself moving already! If you hesitate to try a new gym, we provide you our exclusive free lesson programme for a week.</p>
              <!-- <p><a href="#" class="btn btn-primary">Read more</a></p> -->
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services services-2 text-center d-block" style="background-color : #17a2b8;">
            <div class="icon"><span class="flaticon-diet"></span></div>
            <div class="media-body">
              <h3 class="heading mb-3">35% Discount</h3>
              <p>If you’re anything like me, you struggle to keep up a regular fitness routine. The idea of sweating it out and doing something good for my body provides the motivation I need, but the high cost of gym memberships is enough to stop me from becoming a certified gym rat.</p>
              <!-- <p><a href="#" class="btn btn-primary">Read more</a></p> -->
            </div>
          </div>
        </div>
        <div class="col-md-4 d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block" style="background-color : #42c0fb;">
            ...
            <div class="media-body">
              ...
              <p style="background-color : #42c0fb;">Get to try all our equipments. Feel free to use our gymnasium facilities to the best you can. You can't workout efficiently if you're not well used to with your environment.</p>
              <!-- <p><a href="#" class="btn btn-primary">Read more</a></p> -->
            </div>
          </div>
        </div>
  ...
  <section class="ftco-section ftco-no-pb ftco-no-pt ftco-program bg-light" id="programs-section">
    <div class="container">
      <div class="row no-gutters">
        <div class="col-md-4 ftco-animate py-5 nav-link-wrap js-fullheight" style="background-color : #42c0fb;">
        ...
        <div class="col-md-8 ftco-animate p-4 p-md-5 d-flex align-items-center js-fullheight">
          ...
          <div class="tab-content pl-md-5" id="v-pills-tabContent">
            ...
            <div class="tab-pane fade show active py-0" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-1-tab">
              <span class="icon mb-3 d-block flaticon-gym" style="color: #42c0fb;"></span>
              <h2 class="mb-4">Fitness Program</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt voluptate, quibusdam sunt iste dolores consequatur</p>
              <p>Inventore fugit error iure nisi reiciendis fugiat illo pariatur quam sequi quod iusto facilis officiis nobis sit quis molestias asperiores rem, blanditiis! Commodi exercitationem vitae deserunt qui nihil ea, tempore et quam natus quaerat doloremque.</p>
              <p><a href="#" class="btn btn-primary px-4 py-3" style="border: 1px solid #42c0fb; background-color: #42c0fb;">Learn More</a></p>
            </div>

            <div class="tab-pane fade py-0" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
              <span class="icon mb-3 d-block flaticon-body" style="color: #42c0fb;"></span>
              <h2 class="mb-4">Healthy</h2>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt voluptate, quibusdam sunt iste dolores consequatur</p>
              <p>Inventore fugit error iure nisi reiciendis fugiat illo pariatur quam sequi quod iusto facilis officiis nobis sit quis molestias asperiores rem, blanditiis! Commodi exercitationem vitae deserunt qui nihil ea, tempore et quam natus quaerat doloremque.</p>
              <p><a href="#" class="btn btn-primary px-4 py-3" style="background-color: #42c0fb;">Learn More</a></p>
            </div>

            <div class="tab-pane fade py-0" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
              <span class="icon mb-3 d-block flaticon-woman" style="color: #42c0fb;"></span>
            ...
            <div class="tab-pane fade py-0" id="v-pills-4" role="tabpanel" aria-labelledby="v-pills-4-tab">
              <span class="icon mb-3 d-block flaticon-abs" style="color: #42c0fb;"></span>
            ...
            <div class="tab-pane fade py-0" id="v-pills-5" role="tabpanel" aria-labelledby="v-pills-5-tab">
              <span class="icon mb-3 d-block flaticon-running" style="color: #42c0fb;"></span>
            ...
            <div class="tab-pane fade py-0" id="v-pills-6" role="tabpanel" aria-labelledby="v-pills-6-tab">
              <span class="icon mb-3 d-block flaticon-meditation" style="color: #42c0fb;"></span>
            ...
            <div class="tab-pane fade py-0" id="v-pills-7" role="tabpanel" aria-labelledby="v-pills-7-tab">
              <span class="icon mb-3 d-block flaticon-aerobic" style="color: #42c0fb;"></span>
            ...
            <div class="tab-pane fade py-0" id="v-pills-08" role="tabpanel" aria-labelledby="v-pills-08-tab">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nesciunt voluptate, quibusdam sunt iste dolores consequatur</p>
              <p>Inventore fugit error iure nisi reiciendis fugiat illo pariatur quam sequi quod iusto facilis officiis nobis sit quis molestias asperiores rem, blanditiis! Commodi exercitationem vitae deserunt qui nihil ea, tempore et quam natus quaerat doloremque.</p>
              <p><a href="#" class="btn btn-primary px-4 py-3" style="border: 5px solid #42c0fb; background-color : #42c0fb;">Learn More</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center pb-5">
        <div class="col-md-12 heading-section text-center ftco-animate">
          <span class="subheading" style="color: #42c0fb;">Fit &amp; Healthy</span>
      ...
      <div class="row">
        <div class="col-md d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block">
            <div class="icon"><span class="flaticon-abs" style="color: #42c0fb;"></span></div>
            <div class="media-body">
        ...
        <div class="col-md d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block">
            <div class="icon"><span class="flaticon-scale" style="color: #42c0fb;"></span></div>
            <div class="media-body">
        ...
        <div class="col-md d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block">
            <div class="icon"><span class="flaticon-check-list" style="color: #42c0fb;"></span></div>
            <div class="media-body">
        ...
        <div class="col-md d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block">
            <div class="icon"><span class="flaticon-diet" style="color: #42c0fb;"></span></div>
            <div class="media-body">
        ...
        <div class="col-md d-flex align-self-stretch ftco-animate">
          <div class="media block-6 services text-center d-block">
            <div class="icon"><span class="flaticon-treadmill-machine-with-timer" style="color: #42c0fb;"></span></div>
            <div class="media-body">
  ...
  <!-- BMI Area Starts -->
  <section class="ftco-counter img ftco-section ftco-no-pt ftco-no-pb" id="about-section" style="margin : 50px 5px 50px 5px;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="bmi-text">
            <span class="subheading" style="color: #42c0fb; text-align : right; font-size : 14">CALCULATE YOUR BMI</span><br><br><br>
            <form id="bmi" action="#bmi">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-primary px-4 py-3" style="background-color: #42c0fb;" onclick=calculateBMI()>Calculate</button>
                <br>
              </div>
              <div class="form-group">
            ...
            <script>
              function calculateBMI() {
                ...
                height = document.getElementById("height").value * 30.48;
  ...
  <section class="ftco-section testimony-section" style="background-color: #42c0fb;">
    <div class="container" style="background-color: #42c0fb;">
    ...
    <div class="container">
      <div class="row justify-content-center pb-5">
        <div class="col-md-6 heading-section text-center ftco-animate">
          <span class="subheading" style="color: #42c0fb;">Coaches</span>
          ...
          <div class="staff">
            ...
            <div class="text d-flex align-items-center pt-3 text-center">
              <div>
                ...
                <span class="position mb-4" style="color: #42c0fb;">Owner/Head Coach</span>
                <div class="faded">
          ...
          <div class="staff">
            ...
            <div class="text d-flex align-items-center pt-3 text-center">
              <div>
                ...
                <span class="position mb-4" style="color: #42c0fb;">Coach</span>
                <div class="faded">
                  <ul class="ftco-social text-center">
                    <li class="ftco-animate"><a href="#"><span class="icon-twitter"></span></a></li>
                    <li class="ftco-animate"><a href="#"><span class="icon-facebook"></span></a></li>
    ...
    <div class="container">
      <div class="row justify-content-center mb-5 pb-5">
        <div class="col-md-7 heading-section text-center ftco-animate">
          <span class="subheading" style="color: #42c0fb;">Blog</span>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="site.php#v-pills-08"><span class="icon-long-arrow-right mr-2"></span>Crossfit</a></li><br>
							<li><a href="site.php#v-pills-6"><span class="icon-long-arrow-right mr-2"></span>Yoga</a></li><br>
