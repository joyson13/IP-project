...
if(($result=$conn->query($sql))->num_rows>0)
{
  ...
  #{
    ...
    { 
      ...
      echo "<tr><td colspan='12'><a href='trainer-customerprofile.php?data1=".$customer_id."' style='color : #42c0fb;'>".$customer_name."</a> Says : </td><td colspan='12'>".$feedback_date."</td></tr>";
