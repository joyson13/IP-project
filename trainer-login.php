		...
		<div class="container">
			...
			<div class="row block-9">
				<div class="col-md-7 order-md-last d-flex">
					<form action="testtrainerlogin.php" method="POST" class="bg-light p-4 p-md-5 contact-form">
						<div class="form-group">
							<label for="role">Role</label>
							<input type="role" name="role" class="form-control" value="Trainer" readonly>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" formaction="testtrainerlogin.php" class="btn btn-primary py-3 px-5" style="background-color: #42c0fb; border-color: #42c0fb;">Login</button>
						</div>
					</form>
