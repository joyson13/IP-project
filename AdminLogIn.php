		...
		<div class="container">
			...
			<div class="row block-9">
				<div class="col-md-7 order-md-last d-flex">
					<form action="testadminlogin.php" method="POST" class="bg-light p-4 p-md-5 contact-form">
						<div class="form-group">
							<label for="role">Role</label>
							<input type="role" name="role" class="form-control" value="Administrator" readonly>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" formaction="testadminlogin.php" class="btn btn-primary py-3 px-5" style="background-color: #42c0fb; border-color: #42c0fb;">Login</button>
						</div>
					</form>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4 ml-md-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Coaches</a></li>
				...
				<div class="col-md">
					<div class="ftco-footer-widget mb-4">
						...
						<ul class="list-unstyled">
							...
							<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Yoga</a></li>
